	...
	public static async Task OnExecute(BuildContext context)
	{
		...
		var binaries =
			new List<string> {
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.core.aot",                     "bin", context.ConfigurationText, "net8.0",                                 "xunit.v3.core.aot.dll"),
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.runner.console",               "bin", context.ConfigurationText, "net10.0",        "win-arm64", "publish", "xunit.v3.runner.console.exe"),
